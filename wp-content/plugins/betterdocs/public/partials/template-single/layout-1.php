...
<div class="betterdocs-single-wraper betterdocs-single-bg betterdocs-single-layout1">
	...
	<div class="betterdocs-content-area">
		...
		if ( $enable_sidebar_cat_list == 1 ) {
			include BETTERDOCS_PUBLIC_PATH . 'partials/sidebars/sidebar-1.php';
		} 
		?>
			...
			while ( have_posts() ) : the_post();
				...
				<div class="betterdocs-entry-footer">
					...
					if ($post_social_share == true) {
						$social_sharing_text = get_theme_mod('betterdocs_social_sharing_text', esc_html__('Share This Article :','betterdocs'));
                    ...
                    // email feedback and article update section
